...
public class RadialNormalMesh {
	...
	public RadialNormalMesh(ShaderProgram shaders) {
	...
	public void draw() {
		...
		glUniform4fv(shaders.getUniformLocation("startColor"), startColor.toDfb_());	
		glUniform4fv(shaders.getUniformLocation("endColor"), endColor.toDfb_());
		glUniform2fv(shaders.getUniformLocation("c"), c.toDfb_());
		glUniform1f(shaders.getUniformLocation("r"), r);
	}
